...
Brzuska et al. (ePrint 2024/812) clarified the relationship between vCCA and CPAD: $\mathsf{vCCA}^{SC}$ implies $\mathsf{CPAD}_1$ but neither implies nor is implied by $\mathsf{CPAD}_2$ or full $\mathsf{CPAD}$, contrary to informal claims in the original paper.
